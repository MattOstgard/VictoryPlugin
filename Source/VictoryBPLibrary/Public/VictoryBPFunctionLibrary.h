...
class VICTORYBPLIBRARY_API UVictoryBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Victory BP Library|Load Texture From File", meta = (Keywords = "image texture read color"))
	static bool Victory_GetPixelsArrayFromRenderTarget2D(UTextureRenderTarget2D* RenderTarget2D, int32& TextureWidth, int32& TextureHeight, TArray<FLinearColor>& PixelArray);
